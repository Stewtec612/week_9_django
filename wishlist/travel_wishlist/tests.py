...
class TestVisitedPage(TestCase):
    ...
    def test_visited_page_shows_no_visited_message_for_empty_database(self):
...
class VisitedList(TestCase):
    ...
    class TestAddNewPlace(TestCase):
        ...
        def test_add_new_unvisited_place(self):
            ...
            self.assertTemplateUsed(response, 'travel_wishlist.html')
            ...
            class TestVisitPlace(TestCase):
                ...
                def test_visit_place(self):
                    ...
                    new_york = Place.objects.get(id=2)

                    self.assertTrue(new_york.visited)

                    def test_non_existance_place(self):
